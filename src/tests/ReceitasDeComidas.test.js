...
describe('Tela de Receitas de Comidas', () => {
  ...
  it('3-Verifica ao clicar ícone Search aparace e desaparece SearchBar ', async () => {
    const { getByTestId, findByTestId } = renderWithRouter(<App />, '/foods');
